...
// (z dziennika, od 21.09.2026, sala 31). Plan jest zapisany po NAZWACH
...
const TEACHER_PLAN: Array<[number, number, string]> = [
  [1, 1, 'IV B'], [1, 2, 'V A'], [1, 3, 'IV A'], [1, 4, 'IV A'], [1, 5, 'IV C'], [1, 6, 'IV C'],
  [2, 1, 'V A'], [2, 2, 'IV B'], [2, 4, 'IV C'], [2, 5, 'IV A'], [2, 6, 'IV B'],
  [3, 1, 'IV A'], [3, 2, 'IV C'], [3, 3, 'IV A'],
  [4, 1, 'V A'], [4, 2, 'V A'], [4, 5, 'IV B'],
