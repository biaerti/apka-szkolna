...
const TOPICS: Topic[] = [
  {
    ...
    notebookNote: [
      ...
      'AUTOR A NARRATOR',
      'Autor tworzy tekst. Narrator opowiada historię.',
  ...
  },
  {
    ...
    notebookNote: [
      ...
      'Dobra notatka wybiera najważniejsze informacje - nie kopiuje wszystkiego.', '',
      ...
      '1. Czytam cały fragment. 2. Wybieram słowa-klucze. 3. Dobieram najlepszą formę.', '',
      'PRZYKŁAD',
  ...
  },
  {
    ...
    notebookNote: [
      ...
      'Każda sylaba zawiera samogłoskę.', '',
      'Przykłady:',
      ...
      'W wyrazach „chmura”, „szafa” i „dżem” dwie litery zapisują jedną głoskę.', '',
      'Wyrazy przenosimy do następnej linii tylko między sylabami, np. chmu-ra.',
    ].join('\n'),
    questions: [
  ...
  },
  {
    ...
    notebookNote: [
      ...
      'Epitety: samotny, opuszczony, mroczny, żelazne. Budują tajemniczy, niebezpieczny nastrój.', '',
      'Zamiast ogólnego „fajny skin” napisz dokładniej: „neonowy skin z pękniętą maską”.', '',
      'Autoportret to portret samego siebie wykonany obrazem, zdjęciem albo słowami. Może pokazywać wygląd, charakter i zainteresowania.',
    ].join('\n'),
    questions: [
